  ...
  return (
    <section className={`md:px-20 px-10`} id='hero'>
      <FadeInSection direction={`up`}>
        <div className='w-full md:bg-contain bg-cover bg-no-repeat md:bg-right-top bg-center h-[600px] rounded-2xl text-white' style={{backgroundImage: `url(/images/hero.png)`}}>
