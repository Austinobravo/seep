  ...
  return (
    <section className='md:px-20 px-10'>
      <FadeInSection direction={`up`}>
        <div className='lg:bg-contain bg-no-repeat  w-full bg-cover md:bg-right-top bg-center md:h-[600px] h-[500px] rounded-2xl text-white' style={{backgroundImage: `url(/images/seep_hero.png)`}}>
            <div className='bg-gradient-to-r from-[#0097FF] via-transparent to-transparent md:h-[600px] h-[500px] rounded-2xl flex flex-col md:pl-10 pl-5 justify-center space-y-5'>
